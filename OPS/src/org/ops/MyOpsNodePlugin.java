 ...
 * @author 
 */
public class MyOpsNodePlugin extends AbstractUIPlugin {
    // The shared instance.
    private static MyOpsNodePlugin plugin;

    /**
     * The constructor.
     */
    public MyOpsNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MyOpsNodePlugin getDefault() {
        return plugin;
    }
